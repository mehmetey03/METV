...
class XYZsportsManager:
    ...
    def build_m3u_content(self, base_url, referer_url):
        m3u = ["#EXTM3U"]
    ...
    def calistir(self):
        ...
        try:
            ...
            if not base_url:
                ...
                return
            m3u_content = self.build_m3u_content(base_url, referer_url)
            with open(self.cikti_dosyasi, "w", encoding="utf-8") as f:
                f.write(m3u_content)
            print(f"XYZsports: M3U dosyası oluşturuldu -> {self.cikti_dosyasi}")
...
if __name__ == "__main__":
    manager = XYZsportsManager("xyzvt.m3u")
    manager.calistir()
